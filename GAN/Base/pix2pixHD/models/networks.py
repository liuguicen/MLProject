...
def define_G(input_nc, output_nc, ngf, netG, n_downsample_global=3, n_blocks_global=9, n_local_enhancers=1,
    ...
    '''
    :param n_downsample_global: 下采样层的数量
    :param n_blocks_global: 上采样层的数量
    :param n_local_enhancers:
    :param n_blocks_local:
    :param norm:
    :param gpu_ids:
    :return:
    '''
