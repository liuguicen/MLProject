...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--load_pretrain', type=str, default=r'E:\读研相关\机器学习\预训练模型\pix2pix_G.pth',
    ...
    load_pretrain = r'E:\读研相关\机器学习\预训练模型\pix2pix_G.pth'  # load the pretrained model from the specified location
