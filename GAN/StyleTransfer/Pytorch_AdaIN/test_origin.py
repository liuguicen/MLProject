...
def main():
    ...
    parser.add_argument('--content', '-c', type=str, default=AdaConfig.content,
                        help='Content image path e.g. content.jpg')
    parser.add_argument('--style', '-s', type=str, default=AdaConfig.style,
    ...
    parser.add_argument('--model_state_path', type=str, default= AdaConfig.model_state_path,
