...
if __name__ == '__main__':
    ...
    imageListTensor = real_batch[0].to(device)[:64]
    plt.imshow(
        np.transpose(
            vutils.make_grid(imageListTensor,
                             padding=2,
                             normalize=True).cpu(),
            (1, 2, 0)
        )
    ...
    class Generator(nn.Module):
        def __init__(self, ngpu):
            ...
            self.main = nn.Sequential(
                ...
                nn.ConvTranspose2d(nz, first_c, 4, 1, 0, bias=False),
    ...
    class Discriminator(nn.Module):
        def __init__(self, ngpu):
            ...
            self.main = nn.Sequential(
                ...
                nn.Conv2d(third_c, 1, 4, 1, 0, bias=False),
