...
def parse_args():
    ...
    parser.add_argument('--src_dir', type=str,
                        default=r'D:\MLProject\GAN\intelligenEditing\idinvert_pytorch\examples',
                        help='Source directory, which includes original images, '
                             'inverted codes, and image list.')
    parser.add_argument('--dst_dir', type=str,
                        default=r'D:\MLProject\GAN\intelligenEditing\idinvert_pytorch\dst',
...
def main():
    ...
    generator = build_generator(Config_IdInvert.model_name)
