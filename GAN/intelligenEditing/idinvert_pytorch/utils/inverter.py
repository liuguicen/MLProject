...
class StyleGANInverter(object):
  ...
  def __init__(self,
    ...
    Args:
      weight_path: Name of the model on which the inverted is based. The model
    ...
    self.G = StyleGANGenerator(Config_IdInvert.generator_path, self.logger)
    self.E = StyleGANEncoder(Config_IdInvert.encoder_path, self.logger)
